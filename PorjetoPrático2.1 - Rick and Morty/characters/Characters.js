...
function convertStatus(status) {
    ...
    return characterStatus[status.toLowerCase()] || status; // caso ele não tenha "status", retorna null
}
...
function convertSpecies(specie) {
    ...
    return characterSpecie[specie.toLowerCase()] || specie; // caso ele não tenha "specie", retorna null 
}
...
function convertGender(gender){
   const characterGender = {
    ...
    return characterGender[gender.toLowerCase()] || gender; // caso ele não tenha "Gender", Retorne null 
}
